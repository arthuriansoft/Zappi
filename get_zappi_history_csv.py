...
import run_zappi_csv
import mec.zp
import mec.power_meter_csv
import csv
import os
...
def main():
    ...
    # Load config file
    config = run_zappi_csv.load_config(debug=False)
...
def load_day(server_conn, zid, day, hourly, totals, output_csv=False):
    ...
    pm_totals = {}
    for key in headers:
        pm_totals[key] = mec.power_meter_csv.PowerMeter(show_kWh_in_Data=False)
